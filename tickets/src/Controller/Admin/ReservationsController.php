...
class ReservationsController extends AppController
{
    ...
    public function view($id = null)
    {
        $reservation = $this->Reservations->get($id, [
            'contain' => ['PriceDetails', 'Users', 'ReservationDetails'],
        ]);
    ...
    public function add()
    {
        ...
        $priceDetails = $this->Reservations->PriceDetails->find('list', ['limit' => 200]);
        $users = $this->Reservations->Users->find('list', ['limit' => 200]);
        $this->set(compact('reservation', 'priceDetails', 'users'));
    }
