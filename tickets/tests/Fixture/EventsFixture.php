...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'info' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'image_folder' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        ...
        'is_hot' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        'video' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'country_id' => 1,
                'category_id' => 1,
                'created' => '2021-04-14 08:21:23',
                'modified' => '2021-04-14 08:21:23',
            ],
        ];
        parent::init();
    }
